package com.rodrigo.onboarding_domain.use_case
...
class ValidateNutrients {
    ...
    operator fun invoke(
        ...
        if (carbsRatio == null || proteinRatio == null || fatRatio == null) {
            return Result.Error(message = UiText.StringResources(R.string.error_invalid_values))
        }
        if (carbsRatio + proteinRatio + fatRatio != 100) {
            return Result.Error(message = UiText.StringResources(R.string.error_not_100_percent))
        }
